      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4 rounded-xl border border-zinc-800 bg-zinc-900/80 p-6 shadow-md backdrop-blur-sm">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <Input id="password" name="password" type={show ? "text" : "password"} placeholder="••••••••" autoComplete="current-password" className="bg-zinc-800/60 border-zinc-700 pr-10 focus:border-violet-500 text-zinc-100 placeholder:text-zinc-500 caret-violet-400 focus:bg-zinc-800/70" />
